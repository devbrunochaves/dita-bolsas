  ...
  return (
    <button
      ...
      title={
        disabled
          ...
          : isOn
            ? 'Clique para desativar o colaborador'
            : 'Clique para reativar o colaborador'
      }
      style={{
        position: 'relative',
        width: 54,
    ...
    >
      ...
      <span style={{
        ...
        fontWeight: 800,
        color: 'white',
        left: isOn ? 8 : undefined,
        right: isOn ? undefined : 8,
        lineHeight: 1,
        userSelect: 'none',
      }}>
        {isOn ? '✓' : '✕'}
...
export default function Colaboradores() {
  ...
  const [toggling, setToggling]     = useState(new Set()) // ids sendo alterados
  const { profile: meProfile }      = useAuth()
